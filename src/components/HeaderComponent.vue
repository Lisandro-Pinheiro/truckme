  ...
  <header>
    ...
    <div class="container">
      <router-link to="/" class="nav-link" exact>
        <img src="@/assets/logo_truck_me_frete_plataforma.png" alt="TruckMe Logo" class="logo">
      </router-link>
      <ul class="navbar-nav">
...
<script>
export default {
  // Se houver necessidade de configurar algo específico para o HeaderComponent
};
</script>
